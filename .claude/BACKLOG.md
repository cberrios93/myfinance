...
## 🔵 Próximo release — MyFinance v3: Gestión Patrimonial Profesional
...
| 10 | Feature | Listo DEV | **Módulo Prestamype / Private Credit** — cronograma de pagos, estado (al día/mora), LTV, yield efectivo considerando premium de subasta, capital pendiente, interés cobrado. Datos manuales. Migración `025` pendiente en PROD. |
